...
+ (SLComposeViewController *)composeVCForTwitterWithText:(NSString *)text url:(NSURL *)url;
+ (SLComposeViewController *)composeVCForFacebookWithText:(NSString *)text url:(NSURL *)url;
@end