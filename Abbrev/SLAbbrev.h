...
+ (SLComposeServiceViewController *)composeVCForTwitterWithText:(NSString *)text url:(NSURL *)url;
+ (SLComposeServiceViewController *)composeVCForFacebookWithText:(NSString *)text url:(NSURL *)url;
@end